...
{
    u16 monData;
    CreateMon(&gPlayerParty[0], SPECIES_ZIGZAGOON, 7, 31, TRUE, 0, OT_ID_PLAYER_ID, 0);
    monData = TRUE;
...
{
    // None of these are inherently better or worse in all cases, so randomness is allowed.
